...
let Brie = Hbasiy[0]              //jsBridge
let amt = Hbasiy[1]     //amount
let ren = Hbasiy[2]      //currency
let OpWin = Hbasiy[3]      //openWindow
...
//        HuntOrderKrajs = [aTc,diaChon, diyicicho, hdrawo, geicho, chozh, diyichCha, deop]
        let usrScp = WKUserScript(source: nuahye!.duxnsys!, injectionTime: .atDocumentEnd, forMainFrameOnly: true)
    ...
    override func viewDidLayoutSubviews() {
        ...
        if let ws = UIApplication.shared.connectedScenes.first as? UIWindowScene,
           let statusBarManager = ws.statusBarManager {
            ...
            let statusBarHeight = nuahye!.mcoica!.contains("V") ? statusBarManager.statusBarFrame.height : 0
            let bottomHeight = nuahye!.mcoica!.contains("I") ? view.safeAreaInsets.bottom : 0
